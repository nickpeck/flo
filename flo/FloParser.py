...
class FloParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'\n'", "<INVALID>", "<INVALID>", "<INVALID>", 
                     ...
                     "'!'", "'->'", "'<-'", "'.'", "':'", "'or'", "'and'", 
                     "'{'", "'}'", "'('", "')'", "','", "'dec'", "'module'", 
                     "'component'", "'new'", "'input'", "'output'", "<INVALID>", 
                     "<INVALID>", "<INVALID>", "' '" ]

    symbolicNames = [ "<INVALID>", "CR", "COMMENT", "LINE_COMMENT", "WHITESPACE", 
                      "NUMBER", "PLUS", "MINUS", "MULT", "DIV", "MOD", "EQUALS", 
                      "NEGATION", "BINDTO", "PUTVALUE", "DOT", "COLON", 
                      "OR", "AND", "LCB", "RCB", "LPAREN", "RPAREN", "COMMA", 
                      "DEC", "MODULE", "COMPONENT", "NEW", "INPUT", "OUTPUT", 
                      "STRING", "BOOL", "ID", "SPACE" ]

    RULE_atom = 0
    RULE_declaration = 1
    RULE_compound_expression_paren = 2
    RULE_compound_expression_not = 3
    RULE_compound_expression_mult_div = 4
    RULE_compound_expression_plus_minus = 5
    RULE_compound_expression_and = 6
    RULE_compound_expression_or = 7
    RULE_compound_expression_putvalue = 8
    RULE_compound_expression = 9
    RULE_statement = 10
    RULE_component = 11
    RULE_module = 12

    ruleNames =  [ "atom", "declaration", "compound_expression_paren", "compound_expression_not", 
    ...
    class GetAttribContext(AtomContext):
        ...
        def DOT(self):
            return self.getToken(FloParser.DOT, 0)
    ...
    class StatementContext(ParserRuleContext):
        ...
        def declaration(self):
            return self.getTypedRuleContext(FloParser.DeclarationContext,0)
    ...
    def module(self):
        ...
        self.enterRule(localctx, 24, self.RULE_module)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 140
