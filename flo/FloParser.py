...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\16\2\62\3\2\3\2\5\2\67\n\2\5\29\n\2\3\2\3\2\3\2\6\2>")
        buf.write("\n\2\r\2\16\2?\7\2B\n\2\f\2\16\2E\13\2\3\3\3\3\3\3\3\3")
        buf.write("\7\3K\n\3\f\3\16\3N\13\3\3\3\3\3\3\3\3\3\7\3T\n\3\f\3")
...
class FloParser ( Parser ):
    ...
    RULE_declaration = 2
    RULE_compound_expression_filter = 3
    RULE_compound_expression_not = 4
    RULE_compound_expression_comparison = 5
    RULE_compound_expression_mult_div = 6
    RULE_compound_expression_plus_minus = 7
    RULE_compound_expression_and = 8
    RULE_compound_expression_or = 9
    RULE_compound_expression_putvalue = 10
    RULE_compound_expression = 11
    RULE_compound_expression_paren = 12
    RULE_statement = 13
    RULE_component = 14
    RULE_module = 15

    ruleNames =  [ "atom", "import_statement", "declaration", "compound_expression_filter", 
    ...
    def compound_expression_filter(self):
        ...
        self.enterRule(localctx, 6, self.RULE_compound_expression_filter)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 126
    ...
    def component(self):
        ...
        self.enterRule(localctx, 28, self.RULE_component)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 216
    ...
    def module(self):
        ...
        self.enterRule(localctx, 30, self.RULE_module)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 233
